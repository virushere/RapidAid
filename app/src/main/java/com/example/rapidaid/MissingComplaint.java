...
public class MissingComplaint extends AppCompatActivity {
    ...
    private void CallButton(){
        ...
        if (number.trim().length()>0){
            if (ContextCompat.checkSelfPermission(MissingComplaint.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(MissingComplaint.this,new String[]{Manifest.permission.CALL_PHONE},REQUEST_CALL);
            }else{
