...
public class Railway extends AppCompatActivity {
    ...
    private void CallButton(){
        ...
        if (number.trim().length()>0){
            if (ContextCompat.checkSelfPermission(Railway.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(Railway.this,new String[]{Manifest.permission.CALL_PHONE},REQUEST_CALL);
            }else{
