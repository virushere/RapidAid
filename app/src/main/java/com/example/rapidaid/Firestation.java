...
public class Firestation extends AppCompatActivity {
    ...
    private void CallButton(){
        ...
        if (number.trim().length()>0){
            if (ContextCompat.checkSelfPermission(Firestation.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(Firestation.this,new String[]{Manifest.permission.CALL_PHONE},REQUEST_CALL);
            }else{
