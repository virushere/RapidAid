...
public class SeniorCitizen extends AppCompatActivity {
    ...
    private void CallButton(){
        ...
        if (number.trim().length()>0){
            if (ContextCompat.checkSelfPermission(SeniorCitizen.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
                ActivityCompat.requestPermissions(SeniorCitizen.this,new String[]{Manifest.permission.CALL_PHONE},REQUEST_CALL);
            }else{
